...
export default function AboutCoreValues({ data }: AboutCoreValuesProps) {
  ...
  return (
    <section className="w-full relative overflow-hidden flex flex-col items-center bg-[#7eb2fc]/5 px-4 lg:px-[120px] 2xl:px-[240px] py-[50px] gap-10 text-[#010101] font-sans">
